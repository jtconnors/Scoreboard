...
TARGET=target/Scoreboard-1.2.jar
...
MODULES=(
    ...
    "$REPO/org/openjfx/javafx-media/11.0.2/javafx-media-11.0.2.jar"
    ...
    "$REPO/org/openjfx/javafx-media/11.0.2/javafx-media-11.0.2-$PLATFORM.jar"
)
